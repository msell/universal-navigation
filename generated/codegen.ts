...
export type RecentLaunchesQuery = (
  ...
  & { launchesPast?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'mission_name' | 'launch_year' | 'id' | 'details' | 'launch_success'>
    & { launch_site?: Maybe<(
      { __typename?: 'LaunchSite' }
      & Pick<LaunchSite, 'site_name' | 'site_name_long'>
    )>, links?: Maybe<(
      { __typename?: 'LaunchLinks' }
      & Pick<LaunchLinks, 'flickr_images' | 'mission_patch_small' | 'reddit_media'>
    )> }
  )>>> }
);
 ...
 * });
 */
export function useRecentLaunchesQuery(baseOptions?: Apollo.QueryHookOptions<RecentLaunchesQuery, RecentLaunchesQueryVariables>) {
        return Apollo.useQuery<RecentLaunchesQuery, RecentLaunchesQueryVariables>(RecentLaunchesDocument, baseOptions);
      }
export function useRecentLaunchesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<RecentLaunchesQuery, RecentLaunchesQueryVariables>) {
          return Apollo.useLazyQuery<RecentLaunchesQuery, RecentLaunchesQueryVariables>(RecentLaunchesDocument, baseOptions);
        }
